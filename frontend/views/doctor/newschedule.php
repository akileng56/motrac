...
<div class="schedule-form">
    <h1><?= Html::encode('New Daily Schedule') ?></h1>
    <?php $form = ActiveForm::begin(['action'=> Url::to(['doctor/newschedule']),'id' => 'form-schedule']); ?>
    <table class="table">
        <tr>
            <td>
        ...
        <tr>
            <td>
                <div class="form-group">
                    <?= Html::submitButton( 'Create Schedule', ['class' => 'btn btn-success']) ?>
                </div>
            </td>
